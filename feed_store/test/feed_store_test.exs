defmodule FeedStoreTest do
  ...
  test "Stores the value in the agent" do
    FeedStore.store("url", %{feed: "feed", cached_at: System.system_time(), time_to_live: 5000})
  ...
  test "it returns the cached data while it's fresh" do
    ...
    assert FeedStore.get(url) == %{feed: body, cached_at: cached_at, time_to_live: 3_600_000}
  end
  ...
  test "feeds can have individual TTL" do
    ...
    FeedStore.store("feed2", %{feed: "feed2", cached_at: time, time_to_live: 800})
